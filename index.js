...
const sessdata = config.SESSION_ID.replace("TIMNANDEZ-MD~", '');
...
console.log("CONNECTING TIMNANDEZ-MD 🧬...");
...
console.log('TIMNANDEZ-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ TIMNANDEZ-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Timnandez Gibson ✅*
...
if(senderNumber.includes("254113649244")){
if(isReact) return
m.react("🦋")
   }
